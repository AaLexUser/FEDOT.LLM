...
class TestSupervisorAgent:
    ...
    def test_supervisor_agent_create_graph(self, mock_state_graph_constructor, mock_start_node_str, mock_end_node_str,
        ...
        # Conditional edges are added with add_conditional_edges, not add_edge directly for choose_next
        # The current supervisor.py uses add_conditional_edges
        mock_workflow_instance.add_conditional_edges.assert_called_once_with(
            "choose_next",
            ANY, # The choose_next function itself
            {
